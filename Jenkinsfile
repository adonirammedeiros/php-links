...
def promoteQA () {
	...
	openshiftDeploy(depCfg: 'app-qa', namespace: 'Projeto-teste-002', verbose: 'false', waitTime: '10', waitUnit: 'min')
...
def promotePROD () {
	...
	openshiftDeploy(depCfg: 'app-prod', namespace: 'Projeto-teste-002', verbose: 'false', waitTime: '10', waitUnit: 'min')
